  ...
  <div id="description">
    ...
    <table>
      ...
      <tr>
        <td id="constraints">
          <ul>
            <li>Value of X should be in {-5; -4; -3; -2; -1; 0; 1; 2; 3;}</li>
            <li>Value of Y should be in the range (-5, 3)</li>
            <li>Value of R should be in {1; 2; 3; 4; 5}</li>
          </ul>
        </td>
        <td id="area">
          <img src="client/image/coordinates.jpg" alt="Cartesian coordinate of area">
        </td>
      </tr>
    </table>
  </div>
